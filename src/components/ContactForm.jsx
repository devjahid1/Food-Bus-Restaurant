  ...
  return (
    <div className="mb-[40px]">
      <ContactBanner />
              ...
              <div className=" w-full max-w-[1440px] flex flex-col lg:flex items-center lg:flex-row lg:justify-center">
        ...
        <form ref={form} onSubmit={sendEmail} className="space-y-4">
          ...
          <div className='ml-5 flex flex-col gap-5 mt-0 lg:mt-10 '>
              ...
              <div className='flex items-center gap-2 mb-2'>
                  ...
                  <a href="tel:+8801714974833" target="_blank" className='text-black'>+880-1714-974-833</a>
              </div>
              <div className='flex items-center gap-2 mb-2'>
