const Testimonials = () => {
    return (
        <div className="bg-test w-full max-w-[1440px] mx-auto bg-cover bg-center h-[1000px] lg:h-[800px] pt-1 text-white mb-16 mt-[180px]">
            <div className='text-[16px] text-center mb-10 mt-28'>
            <h2 className=''>TESTIMONIALS</h2>
            <h3 className='text-[22px] lg:text-[40px] font-pacifico'> <span className='text-red-500'>Loved</span> by Foodies & Party-Goers Alike</h3>
            </div>

            <div className="text-center mt-20 font-playwrite text-[20px] lg:text-[32px] lg:mt-32 ">
                <h1>Great food, cozy vibe, and perfect for parties! <br />
The staff made everything smooth and stress-free</h1>
            </div>
...
<h2 className="text-center mt-3 font-plusjakarta text-[24px]">SK Abu Taher</h2>
            </div>
        </div>
    );
};
