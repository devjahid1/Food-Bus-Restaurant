const Testimonials = () => {
    return (
        <div className="bg-test w-full max-w-[1440px] mx-auto bg-cover bg-center h-[1000px] lg:h-[800px] pt-1 text-white mb-16">
            <div className='text-[16px] text-center mb-10 mt-28'>
            <h2 className=''>TESTIMONIALS</h2>
            <h3 className='text-[22px] lg:text-[30px] font-pacifico'> <span className='text-red-500'>Loved</span> by Foodies & Party-Goers Alike</h3>
            </div>
...
<h2 className="text-center mt-3 font-plusjakarta text-[24px]">Shakira Muhsina Khan</h2>
            </div>
        </div>
    );
};
